...
class muPT(Ensemble):
    """
    µPT Monte Carlo Ensemble.

    This class implements the µPT ensemble, where the simulation is conducted under
    constant chemical potential, pressure, and temperature. It extends the `Ensemble`
    base class and defines methods for move selection, execution, and simulation reporting.
    ...
    def __init__(
        ...
        """
        Initialize the µPT ensemble simulation.
        ...
        Args:
            ...
            step_probability (dict[str, float]): Probability distribution for different move types
                (default: {"position": 0.45, "volume": 0.45, "creation": 0.05, "destruction": 0.05}).
    ...
    def start_msg(self) -> None:
        ...
        chemical potentials, step probabilities, and output file configuration.
        """
